# `CLAPHost_jll.jl` (v1.0.0+0)

[![deps](https://juliahub.com/docs/CLAPHost_jll/deps.svg)](https://juliahub.com/ui/Packages/General/CLAPHost_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/914ec615c9b4ef761060dcba101d3eb37e3c0a09/C/CLAPHost/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `CLAPHost_jll.jl` have been built from these sources:

* git repository: https://github.com/SciML/AudioPlugins.jl.git (revision: `a371d82d5a5a476280f8d0ef0571f2768b5f70c8`)

## Platforms

`CLAPHost_jll.jl` is available for the following platforms:
